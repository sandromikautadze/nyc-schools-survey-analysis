...
Still using the previous dataset, we can plot some graphs to easily address this question.

**NOTE** You can visualize the graph also in the `output-graphics` folder.
...
While this is the second graph:
```{r, echo=FALSE}
plot(graph2)
```
